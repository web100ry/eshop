...
use app\assets\AppLtAsset;
use app\assets\AppAsset;

AppAsset::register($this);
AppLtAsset::register($this);
?>
<?php $this->beginPage() ?>
...
//        ['position' => \yii\web\View::POS_HEAD, 'condition'=> 'lte IE9']);
    ...
    <meta name="author" content="web100ry" >
...
\yii\bootstrap\Modal::begin([
    ...
    'footer' => ' <button type="button" class="btn btn-default" data-dismiss="modal">Продовжити покупки</button>
        <a href="'.\yii\helpers\Url::to(['cart/view']).'" type="button" class="btn btn-success" data-dismiss="modal">Оформити замовлення</a>
